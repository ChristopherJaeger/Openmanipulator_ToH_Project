...
class ROS_OM_Node:
    def __init__(self, joint_names, rate_hz=20):
        ...
        self.home_position = [-0.03834952, -0.84062147, 1.26093221, 0.00613592, 1.97576725, -0.00460194]
    ...
    def execute_pick(self, pick, pick_angle=0.0, cube_name=""):
        ...
        joint_traj_1, time_stamps_1 = gen_pick(
            '/root/catkin_ws/src/shaky_robot/DMP_ToH/execution_scripts/recordings/dmp/home2pick.pkl',
    ...
    def execute_place(self,place, place_angle=0.0,cube_name=""):
        ...
        joint_traj_1, time_stamps_1 = gen_place( '/root/catkin_ws/src/shaky_robot/DMP_ToH/execution_scripts/recordings/dmp/home2pick.pkl',
    ...
    def execute_pick_and_place(self,pick, place,pick_angle=0.0, place_angle=0.0):
        ...
        position_pick = pick
        position_place = place
        joint_traj_1, time_stamps_1 = gen_pick_and_place( '/root/catkin_ws/src/shaky_robot/DMP_ToH/execution_scripts/recordings/dmp/home2pick.pkl',
                                                        pick_position=position_pick,
                                                        place_position=position_place,
                                                        pick_angle=pick_angle,
                                                        place_angle=place_angle
...
def gen_pick_and_place(path, pick_position, place_position, pick_angle = 0.0, place_angle=0.0):
    ...
    dmp_path = '/root/catkin_ws/src/shaky_robot/DMP_ToH/execution_scripts/recordings/dmp/home2pick.pkl'
...
def gen_pick(path, pick_position, position_home= np.array([0.05 ,0 ,0.17]), pick_angle = 0.0):
    """
    Computes orientation such that the gripper is allway in pointing down the local z axis
    and the x-axis is alway pointing toward the origin of the xy-plane
...
def gen_place(path, place_position,position_home= np.array([0.05 ,0 ,0.17]), place_angle=0.0):
    """
    Computes orientation such that the gripper is allway in pointing down the local z axis
    and the x-axis is alway pointing toward the origin of the xy-plane
